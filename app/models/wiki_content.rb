...
# options are:
#  * :engine
#    => The structural markup engine to use (Textile, Markdown)
#  * :engine_opts
...
class WikiContent < ActiveSupport::SafeBuffer
  ...
  def initialize(revision, url_generator, options = {})
    ...
    @options[:hide_chunks] = (HIDE_CHUNKS - [Literal::Math] )
  ...
  def build_chunks
    ...
    # The markup (Textile, Markdown etc) can produce such contexts with its own syntax.
