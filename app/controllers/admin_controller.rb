class AdminController < ApplicationController
  ...
  HUBSSOLIB_PERMISSIONS = HubSsoLib::Permissions.new({
    :create_system                     => [ :admin, :webmaster ],
    :create_web                        => [ :admin, :webmaster ],
    :edit_web                          => [ :admin, :webmaster ],
    :remove_orphaned_pages             => [ :admin, :webmaster ],
    :remove_orphaned_pages_in_category => [ :admin, :webmaster ],
    :delete_web                        => [ :admin, :webmaster ],
    :delete_files                      => [ :admin, :webmaster ]
  })
